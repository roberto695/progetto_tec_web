...
INSERT INTO persona (nome, cognome, cf, telefono, email, password) VALUES
('Mario', 'Rossi', 'RSSMRA80A01H501X', '333 1234567', 'mario.rossi@example.com', 'password1'),
('Anna', 'Bianchi', 'BNCANN85B45F205Y', '333 7654321', 'anna.bianchi@example.com', 'password2'),
('Luca', 'Verdi', 'VRDLCU90C15F205Z', '333 9876543', 'luca.verdi@example.com', 'password3');
